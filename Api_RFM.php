 ...
 class Api_RFM
{
    ...
    public function __construct($db,$appcfg_Dominio,$appcfg_Dominio_Corto,$appcfg_Dominio_Raiz,$ID_Solicitud,$ID_Placa,$ID_Clase_Servicio)
	{
		$this->setDB(        $db,
		         $appcfg_Dominio,
	...
	protected function setDB($db,$appcfg_Dominio,$appcfg_Dominio_Corto,$appcfg_Dominio_Raiz,$ID_Solicitud,$ID_Placa,$ID_Clase_Servicio): void	{
		$this->db = $db;
        ...
        $this->ID_Clase_Servicio = $ID_Clase_Servicio;
	}
