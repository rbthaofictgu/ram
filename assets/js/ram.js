...
function lockFormElements() {
  ...
  document.getElementById("editable").setAttribute("title", "Usted esta en modalidad de solo lectura");
}
      ...
      if (currentstep == 3) {
        ...
        if (currentstep == 2) {
          ...
          if (currentstep == 0 && currentstep == 1) {
            alert(currentstep + ' On Click BtnNext Antes');
            fGetInputs();
            alert(currentstep + ' On Click BtnNext Despues');
          }
        }
      }
    }
    ...
    .then(function (Datos) {
      if (
        ...
        if (typeof Datos.ERROR != "undefined") {
          ...
          if (typeof Datos.Multas === "object" && Datos.Multas !== null && Object.keys(Datos.Multas).length > 1) {            
          ...
          if (typeof Datos.Multas1 === "object" && Datos.Multas1 !== null && Object.keys(Datos.Multas1).length > 1) {
          ...
          if (typeof Datos.Placas === "object" && Datos.Placas !== null && Object.keys(Datos.Placas).length > 1) {
          ...
          if (typeof Datos.Preforma === "object" && Datos.Preforma !== null && Object.keys(Datos.Preforma).length > 1) {
