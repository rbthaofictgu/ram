...
function deleteElementFromAutoComplete(Referencia) {   
  //*item !== Concesion
  concesionForAutoComplete = concesionForAutoComplete.filter(Concesion => !Concesion.text.includes(Referencia));
}
...
function fCleanSelectErrorMsg() {
  ...
  function animateValue(element, start, end, duration,clase='highlight',parse=parseFloat,round=2) {
    ...
    function animation(currentTime) {
      ...
      const currentValue = parse((start + (end - start) * progress).toFixed(round));
  ...
  function preDeleteAutoComplete(Concesiones,ElementType='PLACAS') {
    if (ElementType == 'PLACAS' || ElementType == 'TODOS') {
      ...
      deleteElementFromAutoComplete(
        concesionNumber[currentConcesionIndex].Unidad1['ID_Placa_Anterior']
          ? concesionNumber[currentConcesionIndex].Unidad1['ID_Placa_Anterior']
          : concesionNumber[currentConcesionIndex].Unidad1['ID_Placa_Antes_Replaqueo']
      );    
    } else {
      if (ElementType == 'CONCESION') {
        Concesiones.forEach(function(Concesion) {
          ...
          deleteElementFromAutoComplete(
            concesionNumber[currentConcesionIndex].Unidad['ID_Placa_Anterior']
              ? concesionNumber[currentConcesionIndex].Unidad['ID_Placa_Anterior']
              : concesionNumber[currentConcesionIndex].Unidad['ID_Placa_Antes_Replaqueo']
          );    
      ...
      if (typeof Datos.ERROR != "undefined") {
        ...
        if (Monto != false) {
          ...
          if (totalDisplay) {
            ...
            animateValue(total_pagar_ele, Total_A_Pagar, parseFloat(Total_A_Pagar - Monto).toFixed(2), 4000);            
          }
        }
        //*********************************************************************************************************************************/
            ...
            if (placa){
              ...
              if (flecha){
                ...
                if (placa1){
                  ...
                  console.log('add borderPlaca remove borderPlacaSale');
                }
              }          
            }
        ...
        if (typeof datos[0] != "undefined") {
          ...
          if (typeof datos[3] != "undefined" && typeof datos[3][0] != "undefined") {
            ...
            if (typeof datos[4] != "undefined") {
              ...
              document.getElementById("idEstado").innerHTML = datos[4][0]['DESC_Estado'];
  ...
  function fCerrarProceso(){
    ...
    if (document.getElementById("ID_Expediente").value != '') {
      let text = '¿DESEA CERRAR EL EXPEDIENTE RAM Y GENERAR LOS DOCUMENTOS CORRESPONDIENTES?'
    }
    Swal.fire({
  ...
  btnNextList.forEach(function (btn) {
    btn.addEventListener("click", function () {
      if (currentstep == 4) {
        ...
        if (currentstep != 2 || (seRecuperoVehiculoDesdeIP == 0 && currentstep == 2 && document.getElementById("btnSalvarConcesion").style.display != 'none')) {          
          fGetInputs();
          stepperForm.next();
        } else {
...
/*       document.getElementById("NuevaFechaVencimientoConcesion").value =
      ...
      console.log(document.getElementById("NuevaFechaVencimientoConcesion").value,"NuevaFechaVencimientoConcesion");
      console.log(document.getElementById("FechaVencimientoConcesion").value,"FechaVencimientoConcesion");
      console.log(document.getElementById("NuevaFechaVencimientoPerExp").value,"NuevaFechaVencimientoPerExp");
      console.log(document.getElementById("FechaVencimientoPerExp").value,"FechaVencimientoPerExp");
      console.log(document.getElementById("CantidadRenovacionesConcesion").value,"CantidadRenovacionesConcesion");
      console.log(document.getElementById("CantidadRenovacionesPerExp").value,"CantidadRenovacionesPerExp")
        ...
        if (chk.checked) {
          ...
          if (chk.id === 'IHTTTRA-02_CLATRA-01_R_PE') {
            ...
            if (chk.id === 'IHTTTRA-02_CLATRA-02_R_CO' || chk.id === 'IHTTTRA-02_CLATRA-02_R_PS') {
              console.log(document.getElementById("CantidadRenovacionesConcesion").value,"CantidadRenovacionesConcesion Setramites");
              console.log(document.getElementById("NuevaFechaVencimientoConcesion").value,"NuevaFechaVencimientoConcesion Setramites");
              console.log(document.getElementById("FechaVencimientoConcesion").value,"FechaVencimientoConcesion Setramites");
          ...
          if (modalidadDeEntrada == 'I') {
            ...
            if (Datos.Unidad1 != undefined && Datos.Unidad1 != false) {
              if (document.getElementById("ID_Unidad1").value == '') {
                console.log(document.getElementById("ID_Unidad1").value,'document.getElementById("ID_Unidad1").value Antes');
                document.getElementById("ID_Unidad1").value = Datos.Unidad1;
                console.log(document.getElementById("ID_Unidad1").value,'document.getElementById("ID_Unidad1").value Despues');
                console.log(Datos.Unidad1,'Datos.Unidad1');
                Unidad1.ID_Unidad = Datos.Unidad1;
              }
            } else {
              console.log(document.getElementById("ID_Unidad1").value,'document.getElementById("ID_Unidad1").value Antes  Sin UNidad1');
              document.getElementById("ID_Unidad1").value = "";
              console.log(document.getElementById("ID_Unidad1").value,'document.getElementById("ID_Unidad1").value Despues Sin UNidad1');
            }
          }
          //****************************************************************************************************/
...
function fHiddenShowTramites(el, acronimo_tipo, acronimo_clase, checked = true) {
  ...
  const checkboxIds = {
    ['R']: ["IHTTTRA-08_CLATRA-03_X_PS","IHTTTRA-08_CLATRA-02_X_CO","IHTTTRA-08_CLATRA-01_X_PE"],
...
function getVehiculoDesdeIPMoveDatos(vehiculo,Tipo_Tramite) {
  ...
  document.getElementById("concesion"+sufijo+"_categoria").innerHTML = document.getElementById("concesion_categoria").innerHTML;
  document.getElementById("concesion"+sufijo+"_concesion").innerHTML =  document.getElementById("concesion_concesion").innerHTML;
  document.getElementById("concesion"+sufijo+"_perexp").innerHTML = document.getElementById("concesion_perexp").innerHTML;
  document.getElementById("concesion"+sufijo+"_fecexp").innerHTML = document.getElementById("concesion_fecexp").innerHTML;
  document.getElementById("concesion"+sufijo+"_resolucion").innerHTML = document.getElementById("concesion_resolucion").innerHTML;
  document.getElementById("concesion"+sufijo+"_fecven").innerHTML = document.getElementById("concesion_fecven").innerHTML;
  ...
  document.getElementById("concesion"+sufijo+"_nombre_propietario").innerHTML =  vehiculo.cargaUtil.propietario.nombre;
  document.getElementById("concesion"+sufijo+"_identidad_propietario").innerHTML = vehiculo.cargaUtil.propietario.identificacion;
  document.getElementById("concesion"+sufijo+"_vin").value = vehiculo.cargaUtil.vin;
  document.getElementById("concesion"+sufijo+"_placa").value = vehiculo.cargaUtil.placa;
  document.getElementById("concesion"+sufijo+"_serie").value = vehiculo.cargaUtil.chasis;
  document.getElementById("concesion"+sufijo+"_motor").value = vehiculo.cargaUtil.motor;
  document.getElementById("concesion"+sufijo+"_tipo_vehiculo").value = vehiculo.cargaUtil.tipo;
  document.getElementById("concesion"+sufijo+"_modelo_vehiculo").value = vehiculo.cargaUtil.modelo;
  fLlenarSelect(
    "marcas"+sufijo,
    dataConcesion["marcas"],
  ...
  console.log(vehiculo.cargaUtil.colorcodigo,'vehiculo.cargaUtil.colorcodigo getVehiculo');
  fLlenarSelect(
    "anios"+sufijo,
    dataConcesion["anios"],
...
function setaddEventListener() { 
  ...
  const inputCambioUnidad = document.getElementById("concesion_tramite_placa_CU");
  ...
  xhr.onload = function () {
    if (xhr.status === 200) {
      ...
      if (typeof data.msg != 'undefined') {
        ...
        sweetAlert.fire("Oops...", `Estamos presentando inconvenientes para procesar tu petición: ${data.errormsg}`, "error");
      }
    } else {
