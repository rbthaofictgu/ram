  ...
  btnNextList.forEach(function (btn) {
    btn.addEventListener("click", function () {
      if (currentstep == 4) {
        ...
        if (currentstep != 2 || (currentstep == 2 && document.getElementById("btnSalvarConcesion").style.display != 'none')) {          
          fGetInputs();
        }
        stepperForm.next();
      }
      ...
      .then(function (Datos) {
        ...
        if (typeof Datos.ERROR != "undefined") {
          ...
          if (modalidadDeEntrada == 'I') {
            ...
            if (Datos.Unidad1 !== undefined && Datos.Unidad1 !== null && Boolean(Datos.Unidad1)  !== false && Datos.Unidad1 !== 0 && Datos.Unidad1 !== "") {
