...
// Armando el query
$query_rs_mantenimiento = "SELECT a.id, a.correo_electronico, a.nombre, case when a.estado = 1 then 'Inactivo' else 'Activo' end as estado FROM usuarios a order by a.nombre";
...
<table class="table table-hover" width="100%">
	<thead>
		<tr class="gy_detalle_pantalla">
             ...
             <th><div align="left">CORREO ELECTRÓNICO</div></th>                          
	...
	<tr>
        ...
        <td><div align="left"><?php echo $row_rs_mantenimiento['nombre']; ?><a hidden="hidden" href="<?PHP echo $pantalla[0];?>.php?id=<?php echo $row_rs_mantenimiento['id']; ?>" class="style3"><?php echo $row_rs_mantenimiento['nombre']; ?></a></div></td>
                <td><div align="left"><?php echo $row_rs_mantenimiento['correo_electronico']; ?></div></td>        
