...
<body>
   ...
   <div class="main">
      ...
      <div class="p-4 mb-5 mt-5">
         ...
         <div id="id_filter" class="row mb-2">
            <label for=""> <strong> <i class="fa-solid fa-magnifying-glass-chart"></i> SELECCIONE EL TIPO DE BÚSQUEDA
               </strong></label>
            <div class="col-8">
               <div class="row">
                  <div class="col-5">
                     <select id="id_filtro_select" class="form-select form-select-lg mb-3"
                  ...
                  <div class="col-6">
                     <div class="input-group mb-3">
                        ...
                        <input id="id_input_filtro" type="text" class="form-control"
                           placeholder="Introduce criterio de búsqueda" aria-describedby="basic-addon1">
                     </div>
                  </div>
            ...
            <div class="modal fade" id="modalDescripcion" tabindex="-1" aria-labelledby="modalDescripcionLabel"
               ...
               <div class="modal-dialog modal-sm">
                  <!-- modal-sm lo hace pequeño -->
                  <div class="modal-content">
                     <div class="modal-header bg-primary-subtle">
                        <h5 class="modal-title text-primary-emphasis" id="modalDescripcionLabel"></h5>
                        <i id="cerrar" class="fas  fa-window-close fs-4" data-bs-dismiss="modal"></i>

                     </div>
                     <div id="idBody" class="modal-body">
                        <select id='selectD' class="form-select" aria-label="Disabled select example"> </select>
                        <div id="descripcionOtros"></div>

                     </div>
                     <div class="modal-footer">
                        <button id="guardarDescripcion" class="btn btn-success">CAMBIAR ESTADO</button>
                        <button id='idCerrar' type="button" class="btn btn-secondary"
            ...
            <div id='botones' class="col-4">
               <!--  -->
               <button id="idInputBuscar" class="btn btn-primary" title="Boton para realizar la busqueda de solicitud">
                  <i class="fa-duotone fa-solid fa-magnifying-glass"></i> BUSCAR
               </button>
               <button id="idInputLimpiar" class="btn btn-warning" title="Boton para Limpiar busqueda"
                  onclick="limpiar();">
               ...
               <button id="idAgregar" data-info1="IDE-7" class="btn btn-success"
                  title="Boton para Agregar una solicitud" onclick="agregarRams();">
                  <i class="fa-solid fa-plus fs-5"></i> NUEVO
               </button>


               <button id="idPagado" data-pagado="ramsPagadas" class="btn btn-light" title="Boton para filtrar pagados"
                  onclick="ramPagada()">
      ...
      <script type="text/javascript" src="<?php echo $appcfg_Dominio; ?>assets/js/funcionesTablaDinamica.js"></script>
      ...
      <script type="text/javascript" src="<?php echo $appcfg_Dominio; ?>assets/js/tabla_dinamica.js"></script>
      <script type="text/javascript" src="<?php echo $appcfg_Dominio; ?>assets/js/anularAvisoCobro.js"></script>
