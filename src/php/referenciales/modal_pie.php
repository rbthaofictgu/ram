<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
	...
	<div class="modal-header logo_bg">
		...
		<i data-dismiss="modal" aria-label="Close"  onclick="cerrarModal()" class="fa-duotone fa-solid fa-rectangle-xmark fa-2x close"  aria-hidden="true"></i>
	...
	<div class="modal-body">
		...
		<div class="modal-footer">
			<div class="container-fluid text-center">			
					<div class="col">
						<button type="button" class="btn btn-custom-secondary w-100 mx-auto btn-success" onClick="desbloquear();">
